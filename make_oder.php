...
if (isset($_POST['make'])) {
  ...
  if (empty($_POST["order_code"]) || empty($_POST["customer_name"]) || empty($_GET['prod_price'])) {
    ...
    $postQuery = "INSERT INTO rpos_orders (order_id, order_code, customer_id, customer_name, prod_id, prod_name, prod_price, prod_qty) VALUES(?,?,?,?,?,?,?,?)";
    $postStmt = $mysqli->prepare($postQuery);
    //bind paramaters
    $rc = $postStmt->bind_param('ssssssss', $order_id, $order_code, $customer_id, $customer_name, $prod_id, $prod_name, $prod_price, $prod_qty);
    $postStmt->execute();
...
<body>
  ...
  <div class="main-content">
    ...
    ?>
    <!-- Header -->
    <div style="background-image: url(assets/img/theme/img2.jpg); background-size: cover;" class="header  pb-8 pt-5 pt-md-8">
